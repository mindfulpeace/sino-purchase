            ...
            return (
              ...
              >
                <span style={{
                  ...
                  fontSize: 9,
                  fontWeight: 600,
                  background: isSelected ? "var(--activitybar-active-border)" : "var(--bg-2)",
                ...
                {typeOptions.map((opt) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 3,
                      background: colType === opt.value ? "var(--bg-3)" : "transparent",
                ...
                {alignOptions.map((opt) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 3,
                      background: colAlign === opt.value ? "var(--bg-3)" : "transparent",
